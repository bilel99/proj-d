...
@section('content')
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Nos médecin</h1>
    <p class="mb-4"></p>

    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Liste médecin</h6>
        </div>
        <div class="card-body">
            <!-- Buttons -->
            <div id="saveActions" class="form-group float-right">
                <div class="btn-group" role="group">
                    <a href="{{ route('admin.doctors.create') }}" class="btn btn-success btn-icon-split">
