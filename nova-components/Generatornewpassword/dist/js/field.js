...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-generatornewpassword', __webpack_require__(3));
    Vue.component('detail-generatornewpassword', __webpack_require__(6));
    Vue.component('form-generatornewpassword', __webpack_require__(9));
});
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__modal__ = __webpack_require__(11);
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-478d961c", Component.options)
  } else {
    hotAPI.reload("data-v-478d961c", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        generateNewPassword: function generateNewPassword() {
            ...
            Nova.request().get('/user/generate-new-password').then(function (response) {
                _this.newPassword = response.data.result;
  ...
  return _c("transition", { attrs: { name: "modal-fade" } }, [
    _c("div", { staticClass: "modal-backdrop" }, [
      _c(
        "div",
        {
          staticClass: "modal-generate-passwd",
          attrs: {
            role: "dialog",
          ...
          _c(
            ...
            [
              _vm._t("header", [
                _vm._v(
                  "\n                    " +
                    _vm._s(_vm.__("generate new password")) +
                    "\n                    "
                ),
                _c(
                  "button",
            ...
            [
              _vm._t("body", [
                _c("div", { staticClass: "flex mb-4" }, [
                  _c("div", { staticClass: "w-3/5 text-center" }, [
                    _c("span", [_vm._v(_vm._s(_vm.newPassword))])
                  ]),
                  _vm._v(" "),
                  _c("div", { staticClass: "w-2/5" }, [
                    _c(
                      ...
                      {
                        staticClass:
                          "btn btn-default btn-primary items-center relative",
                        attrs: { type: "submit" },
                        on: {
                          click: function($event) {
                            $event.preventDefault()
                            return _vm.generateNewPassword($event)
                          }
                        }
                      },
                      [
              ...
              _vm._t("footer", [
                _c("div", { staticClass: "w-1/2" }, [
                  _c(
                    ...
                    {
                      staticClass:
                        "btn btn-default btn-primary items-center relative w-full",
                      attrs: {
                        type: "button",
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-478d961c", module.exports)
  }
}
            ...
            _c("div", { staticClass: "w-1/2 px-8 py-6" }, [
              _c(
                ...
                [
                  _vm._v(
                    "\n                    " +
                      _vm._s(_vm.__("Confirm Password")) +
                      "\n                "
                  )
                ]
              )
              ...
              _c("input", {
                ...
                on: {
                  change: function($event) {
                    $event.preventDefault()
                    return _vm.validateConfirmPassword($event)
                  },
            ...
            _c("div", { staticClass: "py-6 px-8 w-full" }, [
              _c(
                ...
                [
                  _vm._v(
                    "\n                    " +
                      _vm._s(_vm.__("generate password")) +
                      "\n                "
                  )
                ]
              )
